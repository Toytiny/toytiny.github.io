...
My research centers on *reliable* and *affordable*  **Physical AI**, enabling AI-integrated *physical* systems (e.g., autonomous vehicles, robots, and IoT) to operate responsibly around humans and deliver societal benefits at scale in the *physical* world. My current work advances this goal along three key axes: (i) *safety-assured:* achieving robust performance of physical systems under varied illumination and weather conditions, (ii) *privacy-aware:* protecting user identity and sensitive content in privacy-critical applications, (iii) *cost-effective:* reducing reliance on expensive sensor/compute during deployment and manual data collection and labelling for model training.
