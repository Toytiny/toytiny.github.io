...
My research centers on **Physical AI**, intergrating advanced artifical intelligence with *physical* systems (e.g., autonomous vehicles, robots, industrial and IoT devices) to enable them to perceive, understand, and act in the *physical* world. My long-term vision is a *human–machine symbiotic ecosystem* where human and embodied intelligence coexist, collabroate and co-evolve. The prerequistes for achieving this vision is to develops system that are reliable under changing conditions, responsible around people, and affordable to deploy at scale. My current work advances this goal along three key axes: (i) *condition-adaptive* — maintaining robust performance across illumination, weather, and environmental changes; (ii) *privacy-aware* — protecting user identity and sensitive content in privacy-critical applications; (iii) *cost-effective* — reducing reliance on expensive sensors/compute and manual data collection/labeling.
<!-- 
